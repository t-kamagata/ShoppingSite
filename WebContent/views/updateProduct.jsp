          ...
          <div class="container">
            <div class="columns is-centered">
              <div class="column is-5-tablet is-4-desktop is-3-widescreen">
                <h1>商品情報更新</h1>
                <form name="registerForm" method="POST" action="../controller/update-product" class="box">
                  <input type="hidden" name="id" value="<%= product.getId() %>">
                  <div class="field">
                    <label for="" class="label">商品名</label>
                    <div class="control has-icons-left">
                      <input value="<%= product.getName() %>" name="name" type="text" placeholder="商品名" class="input" required>
                  ...
                  <div class="field">
                    ...
                    <div class="control has-icons-left">
                      <input id="price" value="<%= product.getPrice() %>" name="price" type="text" placeholder="値段" class="input" required>
                      <span class="icon is-small is-left">
                  ...
                  <div class="field">
                    ...
                    <div class="control has-icons-left">
                      <input id="quantity" value="<%= product.getStock() %>" name="stock" type="text" placeholder="数量" class="input" required>
                      <span class="icon is-small is-left">
                        <i class="fa fa-lock"></i>
                      </span>
                    </div>
